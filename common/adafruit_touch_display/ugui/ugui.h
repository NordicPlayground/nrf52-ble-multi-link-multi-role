...
/* -------------------------------------------------------------------------------- */
/* Classic functions */
/* MQ 10/18/2017  If we're not using Nordic GUI then this is the original function else if we are
                  using Nordic GUI then we must pass the LCD driver to this function.  New function defined
                  below in NORDIC_GUI define block.
*/
#ifndef NORDIC_GUI
